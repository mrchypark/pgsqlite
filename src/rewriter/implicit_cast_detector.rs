...
use sqlparser::ast::{BinaryOperator, DataType, Expr, Value, ValueWithSpan};
...
impl ImplicitCastDetector {
    ...
    pub fn check_function_arg_cast(
        ...
        match func_name.to_uppercase().as_str() {
            ...
            "POW" | "POWER" | "SQRT" | "EXP" | "LN" | "LOG" | "SIN" | "COS" | "TAN" | "ASIN"
            | "ACOS" | "ATAN" => {
...
pub enum ImplicitCast {
    ...
    StringToDecimal { expr: Expr, target_type: PgType },
    /// Cast integer to decimal for arithmetic/comparison
    IntegerToDecimal { expr: Expr },
    /// General cast to decimal type
    ToDecimal { expr: Expr, source_type: PgType },
}
