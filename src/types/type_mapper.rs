...
impl TypeMapper {
    pub fn new() -> Self {
        ...
        mapper
            .pg_to_sqlite
            .insert("bool".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("boolean".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("int2".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("smallint".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("int4".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("integer".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("int8".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("bigint".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("float4".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("real".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("float8".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("double precision".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("text".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("varchar".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("char".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("uuid".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("json".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("jsonb".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("date".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("time".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("timestamp".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("timestamptz".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("numeric".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("decimal".to_string(), "DECIMAL".to_string());
        mapper
            .pg_to_sqlite
            .insert("bytea".to_string(), "BLOB".to_string());

        // Additional mappings from PRD
        mapper
            .pg_to_sqlite
            .insert("serial".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("bigserial".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("character varying".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("character".to_string(), "TEXT".to_string());
        mapper.pg_to_sqlite.insert(
        ...
        mapper
            .pg_to_sqlite
            .insert("time with time zone".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("time without time zone".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("timetz".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("interval".to_string(), "INTEGER".to_string());
        mapper
            .pg_to_sqlite
            .insert("datetime".to_string(), "INTEGER".to_string());

        // New type mappings
        mapper
            .pg_to_sqlite
            .insert("money".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("int4range".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("int8range".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("numrange".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("cidr".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("inet".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("macaddr".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("macaddr8".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("bit".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("bit varying".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("varbit".to_string(), "TEXT".to_string());

        // Full-text search types
        mapper
            .pg_to_sqlite
            .insert("tsvector".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("tsquery".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("regconfig".to_string(), "TEXT".to_string());

        // Array type mappings - all arrays stored as JSON TEXT
        mapper
            .pg_to_sqlite
            .insert("bool[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("boolean[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("int2[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("smallint[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("int4[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("integer[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("int8[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("bigint[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("float4[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("real[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("float8[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("double precision[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("text[]".to_string(), "TEXT".to_string());
        mapper
        ...
        mapper
            .pg_to_sqlite
            .insert("date[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("time[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("timestamp[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("timestamptz[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("numeric[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("decimal[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("bytea[]".to_string(), "TEXT".to_string());
        mapper
            .pg_to_sqlite
            .insert("money[]".to_string(), "TEXT".to_string());
        mapper
        ...
        mapper
            .sqlite_to_pg
            .insert("INTEGER".to_string(), PgType::Int4); // OID 23, matches SchemaTypeMapper
        mapper
            .sqlite_to_pg
            .insert("REAL".to_string(), PgType::Float8); // OID 701, matches SchemaTypeMapper
        mapper.sqlite_to_pg.insert("TEXT".to_string(), PgType::Text); // OID 25, matches SchemaTypeMapper
        mapper
            .sqlite_to_pg
            .insert("BLOB".to_string(), PgType::Bytea); // OID 17, matches SchemaTypeMapper
        mapper
            .sqlite_to_pg
            .insert("DECIMAL".to_string(), PgType::Numeric); // OID 1700 for custom DECIMAL type
    ...
    fn extract_base_type(&self, pg_type: &str) -> Option<String> {
            ...
            && let Some(base) = normalized.split('(').next()
        {
            ...
            match base_trimmed {
                "VARCHAR" | "CHARACTER VARYING" | "CHAR" | "CHARACTER" | "NUMERIC" | "DECIMAL"
                | "BIT" => {
...
mod tests {
    ...
    fn test_pg_to_sqlite_for_create_table_serial() {
        ...
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("SERIAL"),
        ...
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("BIGSERIAL"),
            "INTEGER PRIMARY KEY AUTOINCREMENT"
        );
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("bigserial"),
    ...
    fn test_pg_to_sqlite_for_create_table_parametric() {
        ...
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("NUMERIC(10,2)"),
            "DECIMAL"
        );
        assert_eq!(mapper.pg_to_sqlite_for_create_table("BIT(8)"), "TEXT");
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("CHARACTER VARYING(100)"),
            "TEXT"
        );
    }
    ...
    fn test_pg_to_sqlite_for_create_table_multiword() {
        ...
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("DOUBLE PRECISION"),
            "DECIMAL"
        );
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("TIME WITH TIME ZONE"),
            "INTEGER"
        );
        assert_eq!(
            mapper.pg_to_sqlite_for_create_table("TIMESTAMP WITHOUT TIME ZONE"),
            "INTEGER"
        );
    ...
    fn test_extract_base_type() {
        ...
        assert_eq!(
            mapper.extract_base_type("VARCHAR(255)"),
            Some("varchar".to_string())
        );
        assert_eq!(
            mapper.extract_base_type("NUMERIC(10,2)"),
        ...
        // Test multi-word types
        assert_eq!(
            mapper.extract_base_type("DOUBLE PRECISION"),
            Some("double precision".to_string())
        );
        assert_eq!(
            mapper.extract_base_type("CHARACTER VARYING(100)"),
    ...
    fn test_normalize_parametric_type() {
        ...
        // Test normalization
        assert_eq!(
            mapper.normalize_parametric_type("VARCHAR (255)"),
            "VARCHAR(255)"
        );
        assert_eq!(
            mapper.normalize_parametric_type("CHARACTER VARYING (100)"),
            "CHARACTER VARYING(100)"
        );
        assert_eq!(
            mapper.normalize_parametric_type("  NUMERIC ( 10 , 2 )  "),
            "NUMERIC( 10 , 2 )"
        );
    }
}
