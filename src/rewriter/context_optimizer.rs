...
impl ContextOptimizer {
    ...
    pub fn merge_contexts(&self, contexts: Vec<QueryContext>) -> QueryContext {
        ...
        for context in contexts {
            ...
            merged
                ...
                .extend(context.derived_table_columns);
    ...
    pub fn optimize_nested_context(
        &mut self,
        outer_context: &QueryContext,
        inner_contexts: Vec<QueryContext>,
    ) -> QueryContext {
        ...
        optimized
            .table_aliases
            .extend(outer_context.table_aliases.clone());
        optimized
            .cte_columns
            .extend(outer_context.cte_columns.clone());
        optimized
            .derived_table_columns
            .extend(outer_context.derived_table_columns.clone());
        ...
        for inner_context in inner_contexts {
            ...
            optimized
                .derived_table_columns
                .extend(inner_context.derived_table_columns);
    ...
    pub fn cleanup_cache(&mut self) {
        let now = Instant::now();
        self.context_cache
            .retain(|_, cached| now.duration_since(cached.created_at).as_secs() < self.cache_ttl);
    }
...
pub trait QueryContextExt {
    ...
    fn find_table_for_column_optimized(
        &self,
        column: &str,
...
mod tests {
    ...
    fn test_context_caching() {
        ...
        let context1 = optimizer.get_or_create_context("query1", || QueryContext {
    ...
    fn test_context_merging() {
        ...
        ctx1.table_aliases
            .insert("t1".to_string(), "table1".to_string());

        let mut ctx2 = QueryContext::default();
        ctx2.table_aliases
            .insert("t2".to_string(), "table2".to_string());
    ...
    fn test_nested_context_optimization() {
        ...
        outer
            .table_aliases
            .insert("o".to_string(), "outer_table".to_string());
        ...
        inner
            .table_aliases
            .insert("i".to_string(), "inner_table".to_string());
