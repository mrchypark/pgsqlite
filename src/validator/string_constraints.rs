...
mod tests {
    ...
    fn test_validate_value_within_constraint() {
        ...
        assert!(
            validator
                .validate_value("users", "name", "1234567890")
                .is_ok()
        ); // Exactly 10
    }
    ...
    fn test_validate_value_exceeds_constraint() {
        ...
        if let Err(PgError::StringDataRightTruncation {
            type_name,
            column_name,
            actual_length,
            max_length,
    ...
    fn test_no_constraint() {
        ...
        assert!(
            validator
                .validate_value("users", "name", "Any length string should be OK")
                .is_ok()
        );
    }
