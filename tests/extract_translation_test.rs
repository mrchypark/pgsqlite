...
fn test_extract_translation() {
    ...
    println!(
        "Needs translation: {}",
        DateTimeTranslator::needs_translation(query1)
    );
    println!(
        "Translated: {}",
        DateTimeTranslator::translate_query(query1)
    );

    println!("\nQuery 2: {query2}");
    println!(
        "Needs translation: {}",
        DateTimeTranslator::needs_translation(query2)
    );
    println!(
        "Translated: {}",
        DateTimeTranslator::translate_query(query2)
    );
}
