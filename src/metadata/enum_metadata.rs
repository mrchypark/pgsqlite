...
mod tests {
    ...
    fn test_create_enum_type() {
        ...
        let type_oid =
            EnumMetadata::create_enum_type(&mut conn, "mood", &["happy", "sad", "angry"], None)
                .unwrap();
